...
UefiMain (IN EFI_HANDLE ImageHandle, IN EFI_SYSTEM_TABLE *SystemTable ){  
  ...
  efiStatus = CurrentFileHandle->GetInfo(NewFileHandle,&gEfiFileInfoGuid,&FileInfoSize,NULL);
  ...
  if (efiStatus == EFI_BUFFER_TOO_SMALL){    
    ...
    efiStatus = CurrentFileHandle->GetInfo(NewFileHandle,&gEfiFileInfoGuid,&FileInfoSize,FileInfo);    
    ...
    //Print(L"%X bytes of %s read into memory at %X\n",Size, FileName, Buffer);
   Print(L"\n\n**************************************************\n\n");
   Print(L"%X bytes of %s read into memory at %X\n",FileInfoSize, FileName, Buffer);
   Print(L"Nombre del Archivo: %S\n", FileInfo->FileName);
   Print(L"Tamaño de la estructura de información: %d\n", FileInfo->Size);
   Print(L"Tamaño del archivo en bytes: %d\n", FileInfo->FileSize);
   Print(L"Tamaño del archivo en el volumen: %d\n", FileInfo->PhysicalSize);
   Print(L"Ultimo Acceso: %d - %d\n", FileInfo->LastAccessTime.Year, FileInfo->LastAccessTime.Month);
   Print(L"Ultima Modificacion %d - %d\n",FileInfo->ModificationTime.Year,FileInfo->ModificationTime.Month);
   Print(L"Atributos: %d\n", FileInfo->Attribute);
   Print(L"\n\n**************************************************\n\n");
